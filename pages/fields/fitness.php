        ...
        <div class="row">
            <div class="col-sm-3 d-flex justify-content-center mb-5">
                <div class="vertical-menu">
                    ...
                    <a href="fitness.php" class = "btn btn-primary" style="border-radius:0px 0px 5px 5px">Fitness Gyms</a>
                </div>
            </div>
            <div class="col-sm-9">
                <div class="container-fluid">
                    <h3>Available Fitness Gym/s</h3>
                    <div class="tblhead">
                    ...
                    <table class="table">          
                        <tbody>
                        <?php
                        $result = $con->query("select * from fields WHERE field_category = 'fitness gym'");
                            //or die($con->error);
                            $x=1;                      
