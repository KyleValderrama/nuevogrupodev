...
<html lang="en">
  ...
  <body>
    ...
    <!--alert-->
    <div id = "addsuccess" class="alert alert-success alert-dismissible fade show text-center" style="margin:0;" role="alert">
        <strong>New Field Added!</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <!--alert-->
    <div id = "updatefield" class="alert alert-success alert-dismissible fade show text-center" style="margin:0;" role="alert">
        <strong>Field Updated!</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <!--alert-->
    <div id = "deletefield" class="alert alert-warning alert-dismissible fade show text-center" style="margin:0;" role="alert">
        <strong>Field Deleted!</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
        ...
        <div class="row">
            <div class="col-sm-3 d-flex justify-content-center mb-5">
                <div class="vertical-menu">
                    ...
                    <a href="basketball.php" class = "btn btn-primary" style="border-radius:5px 5px 0 0">Basketball Courts</a>
                    ...
                    <a href="swimmingpool.php" class = "btn btn-light" style="border-radius:0">Swimming Pools</a>
                    <a href="fitness.php" class = "btn btn-light" style="border-radius:0px 0px 5px 5px">Fitness Gyms</a>
                </div>
            </div>
            <div class="col-sm-9">
                <div class="container-fluid">
                    <h3>Available Basketball Court/s</h3>
                    <div class="tblhead">
                    ...
                    <table class="table">          
                        <tbody>
                        <?php
                        $result = $con->query("select * from fields WHERE field_category = 'basketball'");
                            //or die($con->error);
                            $x=1;                      
...
<?php   
    unset($_SESSION['deletefield']);
}
?>

<?php
//------- Success Alert UPDATE
if(!isset($_SESSION['updatefield']))
{
?>
<script>
    $('#updatefield').hide();
