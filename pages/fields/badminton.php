        ...
        <div class="row">
            <div class="col-sm-3 d-flex justify-content-center mb-5">
                <div class="vertical-menu">
                    ...
                    <a href="badminton.php" class = "btn btn-primary" style="border-radius:0">Badminton Courts</a>
            ...
            <div class="col-sm-9">
                <div class="container-fluid">
                    <h3>Available Badminton Court/s</h3>
                    <div class="tblhead">
                    ...
                    <table class="table">          
                        <tbody>
                        <?php
                        $result = $con->query("select * from fields WHERE field_category = 'badminton'");
                            //or die($con->error);
                            $x=1;                      
